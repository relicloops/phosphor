...
static const ph_argspec_t create_specs[] = {
    ...
    {"template", PH_TYPE_PATH, PH_FORM_VALUED, true, NULL, NULL, 0,
...
static const ph_argspec_t serve_specs[] = {
    ...
    /* neonsignal logging */
    {"debug", PH_TYPE_BOOL, PH_FORM_TOGGLE, false, NULL, NULL, 0,
     "neonsignal debug logging (stderr)"},
    {"log", PH_TYPE_BOOL, PH_FORM_TOGGLE, false, NULL, NULL, 0,
     "neonsignal request/response access logging (stdout)"},
    {"log-color", PH_TYPE_BOOL, PH_FORM_TOGGLE, false, NULL, NULL, 0,
     "colorful access log output with symbols"},
    {"file-log", PH_TYPE_BOOL, PH_FORM_TOGGLE, false, NULL, NULL, 0,
     "write JSON log files to disk"},
    {"log-directory", PH_TYPE_PATH, PH_FORM_VALUED, false, NULL, NULL, 0,
     "directory for JSON log files (required with --enable-file-log)"},
    {"proxies-check", PH_TYPE_BOOL, PH_FORM_TOGGLE, false, NULL, NULL, 0,
     "log proxy health check requests (normally excluded)"},
    /* watch */
