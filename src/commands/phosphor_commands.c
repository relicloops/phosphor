...
static const ph_argspec_t serve_specs[] = {
    ...
    /* neonsignal logging */
    {"enable-debug", PH_TYPE_BOOL, PH_FORM_ACTION, false, NULL, NULL, 0,
     "enable neonsignal debug logging (stderr)"},
    {"enable-log", PH_TYPE_BOOL, PH_FORM_ACTION, false, NULL, NULL, 0,
     "enable neonsignal request/response access logging (stdout)"},
    {"enable-log-color", PH_TYPE_BOOL, PH_FORM_ACTION, false, NULL, NULL, 0,
     "colorful access log output with symbols"},
    {"enable-file-log", PH_TYPE_BOOL, PH_FORM_ACTION, false, NULL, NULL, 0,
    ...
    {"disable-proxies-check", PH_TYPE_BOOL, PH_FORM_ACTION, false, NULL, NULL, 0,
